...
person_tag = ["Ottavio Dantone", "Margret Köll", "Margret Koell", "Claudio Monteverdi", "Pier-Luigi Pizzi", "Luciano Berio", "Francesco Rognoni ", "Emilia Fadini"]
project_category = "Podcast: Between the Strings"
relatedresearch = []
show_in_news = true
status = "draft"
subjects_tag = ["recitar cantando", "Academia Bizantina", "Teatro Comunale di Ferrara", "Orpheus", "L'Orfeo", "Orfeo", "Eurydice", "Euridice", "Messagera", "Messagiera", "mutatio toni", "enharmony", "Seicento", "Programmmusik", "programme music", "program music", "passus duriusculus", "theorbo", "positive organ", "harpsichord", "harp", "tonality", "modality", "opera", "\"Possente spirto\"", "canto", "melisma", "violin", "cornet", "Charon", "harmonic concept", "modal phrase", "prosody", "zither", "cadenza", "Follia", "folia", "Ulisse", "Poppea", "flute", "chitarrone", "Baroque", "trombone", "trumpet", "organ", "\"Rinaldo\"", "basso continuo"]
