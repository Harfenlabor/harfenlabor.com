...
imgcaptions = "Ottavio Dantone demonstrates the mysterious recitar cantando through some of the key moments in Claudio Monteverdi´s masterpiece <i>L'Orfeo</i>. Dantone accompanies himself on the harpsichord on stage of the Teatro Comunale di Ferrara, in conditions similar to how the opera would have been performed in the 17th century.  "
map_tag = []
person_tag = []
project_category = ""
relatedresearch = []
