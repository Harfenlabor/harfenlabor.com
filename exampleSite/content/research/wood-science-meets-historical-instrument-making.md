...
imgcaptions = ""
map_tag = []
person_tag = ["Volker Haag", "Eric Kleinmann", "George-Frideric Handel"]
project_category = "Barberini Harp Project"
relatedresearch = []
show_in_news = false
status = "draft"
subjects_tag = ["Barberini Harp", "construction", "gilding", "wood scientist", "harp maker", "soundboard", "column", "neck", "strings", "string hole", "copy", "brace", "Harp Concerto", "body", "interpretation", "dendrochronology", "fir", "walnut", "spruce", "Thirty Years’ War"]
subtype = ["Organology"]
