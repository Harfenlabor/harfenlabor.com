...
subtype = ["Organology"]
summary_text = "This report by the Institut für Holzforschung, Thünen-Institut (Hamburg) presents the findings of the anatomical determination of structural features for wood species found on the Barberibi Harp, carried out on December 16-18, 2018 by Volker Haag and Valentina Zemke, at the Museo Nazionale degli Strumenti Musicali (Roma), using the non-destructive high-resolution 3D-reflected-light microscopy. Structural features detected on the examined areas of the harp were compared with data held in the scientific wood collection at the Thünen-Institut, and on  February 18, 2019, Volker Haag presented the findings in a report to Harfenlabor."
