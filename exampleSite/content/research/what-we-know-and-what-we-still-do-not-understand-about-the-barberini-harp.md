...
summary_text = "Chiara Granata and Dario Pontiggia present findings and analysis related to new facts about the Barberini Harp. By integrating technical and historical research, they offer facts as well as open questions about this sumptuous musical instrument and its contexts. Unlike the other analyses presented by Harfenlabor, Granata and Pontiggia do not believe that Giovanni Lanfranco's painting <i>Venus Playing</i> the Harp depicts the Barberini Harp."
